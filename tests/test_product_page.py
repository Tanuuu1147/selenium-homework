...
def test_product_page(browser, base_url):
    ...
    wait_element(browser, "#button-cart")                   # 2 кнопка в корзину
    wait_element(browser, "#input-quantity")                # 3 поле количества
    wait_element(browser, ".nav-tabs")                      # 4 вкладки
    # 5 — блок цены/описания (в темах отличается, ловим один из вариантов)
